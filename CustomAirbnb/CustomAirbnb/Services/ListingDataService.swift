...
class ListingDataService {
    ...
    func getListings() {
        guard let url = URL(string: "https://public.opendatasoft.com/api/explore/v2.1/catalog/datasets/airbnb-listings/records?limit=20&refine=room_type%3A%22Entire%20home%2Fapt%22&refine=city%3A%22Barcelona%22") else { return }
